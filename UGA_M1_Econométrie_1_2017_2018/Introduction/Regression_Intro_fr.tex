\input{../Config_slides_fr}


\newcommand{\CurrentPart}{}
\newenvironment{frenchpartie}[1]
{\part{#1} \renewcommand{\CurrentPart}{{\bfseries \Roman{part} #1}}\setcounter{section}{0}\begin{otherlanguage}{english}\renewcommand{\partname}{Partie}}
{\end{otherlanguage}\frame[t]{\frametitle{\hfil\CurrentPart\hfil}\tableofcontents}}
\newcommand{\Partie}[1]{\begin{frenchpartie}{#1}\frame{\partpage}\end{frenchpartie}\setcounter{section}{0}\renewcommand{\CurrentPart}{{\bfseries \Roman{part} #1}}}
\newcommand{\SectionTdm}{\mode<beamer>{\begin{frame}\frametitle{\hfil\CurrentPart\hfil}\tableofcontents[currentsection]\end{frame}   \addtocounter{framenumber}{-1}
}}

\title[Econométrie 1: Régression]{UGA M1: \'Econometrie 1\\
  \textbf{Introduction aux modèles de régression linéaire}}
\date{\today}
...
\Partie{Définitions et interprétation}
